...
import { getRuntimeBoolean, getRuntimeEnv } from '@/config/runtimeEnv'
...
export const DATA_SOURCE: DataSourceMode =
  (getRuntimeEnv('VITE_DATA_SOURCE') as DataSourceMode) === 'mock' ? 'mock' : 'api'
...
export const customerOrdersApiEnabled = () =>
  getRuntimeBoolean('VITE_ORDERS_API')
