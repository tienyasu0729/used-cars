...
import { X, LayoutDashboard, Calendar, CalendarCheck, MessageSquare, Package, PlusCircle, ClipboardList, Banknote, ListChecks, MessageCircle, ArrowLeftRight, User, Bell, FileText } from 'lucide-react'
