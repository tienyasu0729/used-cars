...
const navItems = [
  ...
  { to: '/admin/articles', icon: Newspaper, label: 'Bài viết' },
  { to: '/admin/reviews', icon: Star, label: 'Đánh giá xe' },
  { to: '/admin/used-car-purchase-requests', icon: WalletCards, label: 'Duyet mua xe cu' },
]
