...
export function VehicleDetailPage() {
  ...
  const { vehicle, isLoading, error, isSaved, toggleSave, refetchVehicle } = useVehicleDetail(id, {
    ...
    <div className="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
      ...
      <div className="grid gap-8 lg:grid-cols-12">
        ...
        <div className="flex flex-col gap-6 lg:col-span-4">
          ...
          <InstallmentCalculatorWidget vehiclePrice={vehicle.price} vehicleId={vehicle.id} />
      ...
      {/* Đánh giá xe */}
      <VehicleReviewSection vehicleId={vehicle.id} />
