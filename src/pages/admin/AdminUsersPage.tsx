                  ...
                  <tr key={u.id} className="transition-colors hover:bg-slate-50">
                    ...
                    <td className="px-4 py-3">
                      <div className="flex flex-wrap justify-end gap-1">
                        <button type="button" className="rounded p-1.5 text-slate-500 hover:bg-[#1A3C6E]/10 hover:text-[#1A3C6E]" title="Sửa" onClick={() => setEditUser(u)}>
                          <Pencil className="h-4 w-4" />
                        </button>
                        <button type="button" className="rounded p-1.5 text-slate-500 hover:bg-slate-100 hover:text-slate-700" title="Xem">
