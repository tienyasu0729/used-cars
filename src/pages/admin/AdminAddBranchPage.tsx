  ...
  return (
    <div className="mx-auto max-w-6xl space-y-6">
      ...
      <div>
        ...
        <p className="mt-1 text-slate-500">Điền thông tin bên dưới để đăng ký địa điểm đại lý mới tại Đà Nẵng.</p>
      </div>
          ...
          <div className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <input {...form.register('phone', { required: true })} placeholder="+84 236 XXX XXXX" className="w-full rounded-lg border border-slate-200 px-3 py-2 text-sm focus:border-[#1A3C6E] focus:ring-1 focus:ring-[#1A3C6E]" />
              </div>
              <div>
                <label className="mb-1 block text-sm font-medium text-slate-700">Email</label>
                <input {...form.register('email')} type="email" placeholder="branch@banxeoto.vn" className="w-full rounded-lg border border-slate-200 px-3 py-2 text-sm focus:border-[#1A3C6E] focus:ring-1 focus:ring-[#1A3C6E]" />
              </div>
              <div>
                <label className="mb-1 block text-sm font-medium text-slate-700">Giờ làm việc</label>
                <input {...form.register('workingHours')} placeholder="vd. 08:00 - 18:00" className="w-full rounded-lg border border-slate-200 px-3 py-2 text-sm focus:border-[#1A3C6E] focus:ring-1 focus:ring-[#1A3C6E]" />
              </div>
              <div>
                <label className="mb-1 block text-sm font-medium text-slate-700">Quận/Huyện</label>
                <select {...form.register('district')} className="w-full rounded-lg border border-slate-200 px-3 py-2 text-sm focus:border-[#1A3C6E] focus:ring-1 focus:ring-[#1A3C6E]">
              ...
              <div>
                ...
                <textarea {...form.register('description')} rows={3} placeholder="Mô tả ngắn về dịch vụ và điểm nổi bật của chi nhánh..." className="w-full rounded-lg border border-slate-200 px-3 py-2 text-sm focus:border-[#1A3C6E] focus:ring-1 focus:ring-[#1A3C6E]" />
              </div>
            </div>
          </div>
          <div className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
            ...
            <div className="rounded-lg border-2 border-dashed border-slate-300 bg-slate-50/50 py-12 text-center">
              ...
              <p className="mt-2 text-sm text-slate-600">Nhấp hoặc kéo thả ảnh PNG, JPG, JPEG tối đa 10MB (Tối đa 10 ảnh).</p>
              <Button variant="outline" size="sm" className="mt-4" type="button">Chọn ảnh</Button>
            </div>
            <div className="mt-4 flex gap-4">
              {[1, 2].map((i) => (
                <div key={i} className="flex h-24 w-24 items-center justify-center rounded-lg bg-slate-200">
        ...
        <div className="space-y-6">
          <div className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
            <div className="mb-4 flex items-center gap-2">
              ...
              <h4 className="font-semibold text-slate-900">Tọa độ GPS</h4>
            </div>
            <div className="space-y-4">
              <div>
                <label className="mb-1 block text-sm font-medium text-slate-700">Vĩ độ</label>
                <input {...form.register('latitude')} className="w-full rounded-lg border border-slate-200 px-3 py-2 text-sm focus:border-[#1A3C6E] focus:ring-1 focus:ring-[#1A3C6E]" />
              </div>
              <div>
                <label className="mb-1 block text-sm font-medium text-slate-700">Kinh độ</label>
                <input {...form.register('longitude')} className="w-full rounded-lg border border-slate-200 px-3 py-2 text-sm focus:border-[#1A3C6E] focus:ring-1 focus:ring-[#1A3C6E]" />
              </div>
          ...
          <div className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
            ...
            <p className="mt-2 text-xs text-slate-500">* Chi nhánh mới được bật mặc định và sẽ hiển thị trên website công khai ngay sau khi tạo.</p>
          </div>
        </div>
      </form>
    </div>
