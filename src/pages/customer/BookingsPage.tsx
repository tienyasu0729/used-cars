...
export function BookingsPage() {
  ...
  const filtered =
    activeTab === 'all'
      ...
      : allBookings.filter((b) => {
          if (activeTab === 'pending') return b.status === 'AwaitingContract' || b.status === 'Pending' || b.status === 'Rescheduled'
  ...
  const tabCounts = useMemo(() => {
    const pending = allBookings.filter((b) => b.status === 'AwaitingContract' || b.status === 'Pending' || b.status === 'Rescheduled').length
