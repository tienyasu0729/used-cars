...
export function InstallmentWizardPage() {
  ...
  const { vehicle, isLoading: vehicleLoading } = useVehicleDetail(paramId)
  ...
  if (!vehicle) {
    return (
      <div className="mx-auto max-w-3xl px-4 py-20 text-center">
        <h2 className="text-xl font-bold text-slate-900">Không thể tải thông tin xe</h2>
        <p className="mt-2 text-slate-500">
          Xe có thể đang tạm khóa hiển thị. Vui lòng quay lại lịch sử trả góp và chọn "Tiếp tục hoàn tất hồ sơ" một lần nữa.
        </p>
