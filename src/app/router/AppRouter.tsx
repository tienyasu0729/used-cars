...
const ManagerVehiclePricingPage = lazy(() => import('@/pages/manager').then((m) => ({ default: m.ManagerVehiclePricingPage })))
...
const AdminUsedCarPurchaseRequestsPage = lazy(() => import('@/pages/admin').then((m) => ({ default: m.AdminUsedCarPurchaseRequestsPage })))
...
const router = createBrowserRouter([
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'vehicle-pricing', element: <Suspense fallback={<Fallback />}><ManagerVehiclePricingPage /></Suspense> },
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'used-car-purchase-requests', element: <Suspense fallback={<Fallback />}><AdminUsedCarPurchaseRequestsPage /></Suspense> },
      { path: 'profile', element: <Suspense fallback={<Fallback />}><ProfilePage /></Suspense> },
      { path: 'security', element: <Suspense fallback={<Fallback />}><SecurityPage /></Suspense> },
    ],
  },
