...
import { getRuntimeEnv, getRuntimeNumber, isViteDev } from '@/config/runtimeEnv'
...
const baseURL = normalizeApiBaseUrl(getRuntimeEnv('VITE_API_BASE_URL', '/api/v1'))

const parsedTimeout = getRuntimeNumber('VITE_API_TIMEOUT_MS', 0)
const requestTimeoutMs = parsedTimeout > 0
  ? parsedTimeout
  : isViteDev
    ? 60000
    : 30000
